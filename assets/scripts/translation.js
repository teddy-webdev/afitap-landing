...
const i18nData = {
  en: {
    ...
    resto: "Restaurant",
    date: "Date",
    resto_desc: "Afitap kebab is a kebab restaurant founded in 2020, a subsidiary of Musmer Limited Trading.",
    sensitive: "Sensitive",
  ...
  tr: {
    ...
    resto: "Restoran",
    date: "Tarih",
    resto_desc: "Afitap kebap, Musmer Limited Trading'in bir yan kuruluşu olan 2020 yılında kurulmuş bir kebap restoranıdır.",
    sensitive: "Duyarlı",
...
ru: {
  ...
  resto: "Ресторан",
  date: "Дата",
  resto_desc: "Afitap kebab — кебаб-ресторан, основанный в 2020 году, дочерняя компания Musmer Limited Trading.",
